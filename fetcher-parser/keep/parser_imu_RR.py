...
- rr_count
- avg_hr_bpm
- cumulative_time_ms estimated from RR intervals only
...
def parse_HR_RR_chunk(data_bytes, chunk_index, cumulative_time_ms):
    ...
    data_chunks.append({
        ...
        "cumulative_time_ms_start": cumulative_time_ms,
        "cumulative_time_ms_end": cumulative_time_ms + packet_duration,
    })
